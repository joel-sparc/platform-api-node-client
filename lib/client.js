 ...
 * @param  {Object}   body When opts.method is POST or PUT, then a request body may be provided
...
Client.prototype.request = function(opts, body, cb) {
	...
	// handle POST/PUT behavior
	if (method === 'POST' || method === 'PUT') {
		// set the headers
		options.headers = {
			'Content-Type': 'application/x-www-form-urlencoded'
			// @todo: should we set Content-Length or use the defualt chunked encoding?
		};
