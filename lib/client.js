 ...
 * @param  {Object} opts An Object containing the Client options (host and port and landlord are required)
 * @return {Client}
 */
var Client = module.exports = function Client(opts) {
	...
	// validate options
	opts || (opts = {});
	['host', 'port', 'landlord'].forEach(function(key) {
